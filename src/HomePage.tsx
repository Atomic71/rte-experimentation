  ...
  const editors = [
    {
      ...
      status: 'implemented',
      features:
        'Full formatting, lists, headings, keyboard shortcuts, RTL/LTR support',
    },
    {
      name: 'Lexical',
      path: '/lexical',
  ...
  return (
    ...
    >
        ...
        {editors.map((editor) => (
          <div
            ...
            style={{
              ...
              textAlign: 'center',
              cursor:
                editor.status === 'implemented' ? 'pointer' : 'not-allowed',
      ...
      >
        ...
        <p>
          When used in a WebView, pass the editor type as a query parameter:
        </p>
        <code
          style={{
            display: 'block',
